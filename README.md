...
<img src='https://github.com/mchanni1321/InstaClient/blob/master/walkthrough2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

After building this application, I noticed that the images were not visible on the timeline.  However, after modifying the Android Manifest XML file by adding "android:usesCleartextTraffic="true", I was able to get the images to appear properly.
